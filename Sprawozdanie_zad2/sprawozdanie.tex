...
\begin{document}
	...
	\begin{itemize}
		\item Klasy Atrybut i dziedziczące po niej reprezentują poszczególne kolumny w bazie danych
		\item CSVReader odpowiada za wczytanie pliku csv z danymi do programu
		\item FifaDatabse odpowiada za bazę danych, czyli przechowywanie wszystkich rekordów
	...
	\newpage
	\subsection{Kwantyfikator}
	
	Poniżej przedstawiliśmy wartości parametrów oraz wykres funkcji przynależności dla kwantyfikatora. Liczba rekordów w naszej bazie danych wynosi 18278, dlatego wykres zawiera się w wartościach [0, 18278].
	\begin{table}[h!]
		\centering
		\begin{tabular} {c c c c c}
			\hline
			...
			\hline	
			\hline 
			prawie nikt			 & 0 & 0 & 1000 & 3000 \\
			mniejszość			 & 2000 & 3000 & 7000 & 8000  \\
			połowa			 & 7500 & 8000 & 10000 & 10500  \\
			większość & 10000 & 11000 & 15000 & 16000  \\	
			prawie wszyscy			 & 15000 & 16500 & 18278 & 18278  \\						
			\hline
		\end{tabular}
		\caption{Przyporządkowane parametry funkcji trapezoidalnej dla kwantyfikatora. }
		\label{tabelaKwantyfikator}
	\end{table}
	
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.9\textwidth]{kwantyfikator.png}
		\caption{Funkcja przynależności kwantyfikatora.}
		\label{kwantyfikator}
	\end{figure}
