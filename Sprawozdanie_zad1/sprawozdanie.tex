...
\item[•] $C_{11}$ - Najczęściej występujące słowo kluczowe. Jest to cecha tekstowa, której podobieństwo z innym słowem mierzymy jedną z dwóch miar opisanych w sekcji \textsl{Metryki i miary podobieństwa}.
\end{itemize}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{testtren.png}
